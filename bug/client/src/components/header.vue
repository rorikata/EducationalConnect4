    ...
    <nav class="navbar navbar-default">
        <div class="container">
            <ul class="nav navbar-nav">
                ...
                <li v-if="user.authenticated"><router-link to="/settings" exact>Profile</router-link></li>
                <li v-if="user.authenticated"><router-link to="/profile" exact>Rules</router-link></li>
